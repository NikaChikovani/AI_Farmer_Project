...
#define CONFIG_POST_URL "https://api.aifarmer.co/create-greenhouse"
#define CONFIG_GET_URL "https://api.aifarmer.co/desired-greenhouse/"
...
#define CONFIG_ESP_WIFI_SSID "POCO M3"
#define CONFIG_ESP_WIFI_PASSWORD "struct11"
